    ...
    <ScrollView style={styles.wrapper}>
      ...
      <View style={styles.about}>
        ...
        <TextFont style={styles.aboutText} font="NunitoSans_Regular">
          Experience the beauty of local art with an exhibit featuring works
          from up-and-coming artists. Experience the beauty of local art with an
          exhibit featuring works from up-and-coming artists. Experience the
          beauty of local art with an exhibit featuring works from up-and-coming
          artists.
        </TextFont>
      </View>
    </ScrollView>
